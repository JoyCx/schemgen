...
mod tests {
    ...
    fn remaps_copper_to_waxed() {
        assert_eq!(
            sanitize("minecraft:oxidized_cut_copper").as_deref(),
            Some("minecraft:waxed_oxidized_cut_copper")
        );
        assert_eq!(
            sanitize("minecraft:waxed_copper_block").as_deref(),
    ...
    fn rejects_griefable_and_invalid() {
        for id in [
            ...
            "minecraft:grass_block_snow",
            "minecraft:mushroom_block_inside",
            "minecraft:crafter_east_triggered",
            "minecraft:beehive_end",
